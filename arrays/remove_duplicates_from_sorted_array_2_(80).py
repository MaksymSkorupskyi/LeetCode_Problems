...
# Runtime: 52 ms, faster than 80.13% of Python3 online submissions for Remove Duplicates from Sorted Array II.
# Memory Usage: 14.2 MB, less than 60.38% of Python3 online submissions for Remove Duplicates from Sorted Array II.
class Solution:
...
def main():
    ...
    assert solution.removeDuplicates([-1, 0, 0, 0, 0, 3, 3]) == 5
